...
def fuse_with_map(
    ...
    #Tranform the new pointclouds to the map frame from ns frame
    # print("Applying transform...")
    # # applied_transforms = torch.zeros(3, 4)
    # # bot_row = torch.tensor([[0, 0, 0, 1],])
    # # applied_transforms = torch.vstack((applied_transforms, bot_row))
    # new_pointclouds.transform(applied_transforms.to(device))
